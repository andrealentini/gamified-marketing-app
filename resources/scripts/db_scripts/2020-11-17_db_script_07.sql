...
BEGIN
    ...
    IF m_type = 1 THEN ROLLBACK; END IF;
    IF s_type = 0 THEN ROLLBACK; END IF;
END
$$
...
DELIMITER $$
DROP TRIGGER IF EXISTS `offensive_word_insert_check`;
CREATE TRIGGER `offensive_word_insert_check`
BEFORE INSERT ON 
